...
import Confirmation from "@/app/(admin)/admin/components/confirmation";
import {
  createVendor,
  listVendors,
  removeVendor,
} from "@/app/data/vendor/vendor";
...
export default function VendorsList() {
  ...
  const {
    ...
    resolver: async (data, context, options) => {
      ...
      console.log(
        "validation result",
        await yupResolver(VendorSchema)(fulldata, context, options)
      );
      return yupResolver(VendorSchema)(fulldata, context, options);
    },
  });
