...
const AgentPayProcessingForm = ({ txndetails }) => {
  ...
  const furl = `${process.env.NEXT_PUBLIC_API_BASE_URL}/api/exam/agentpaymentfailure`;
...
export default AgentPayProcessingForm;
